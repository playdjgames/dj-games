...
export const Logo = ({ className, asLink = true }: LogoProps) => {
  const mark = (
    <span className={cn("group inline-flex select-none items-center gap-2", className)}>
      <span
        className="relative flex h-9 items-center bg-ember px-2 font-display text-[1.35rem] font-black uppercase leading-none tracking-tight text-[#0a0f0d] transition-transform duration-300 group-hover:-translate-y-0.5"
